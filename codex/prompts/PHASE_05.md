# Prompt de implementação — PHASE_05

Você está implementando a PHASE_05: Motor financeiro e pagamentos, no SaaS multiagência de excursões/viagens.

Leia AGENTS.md, README.md, docs/SPEC.md, docs/AUDIT_G1.md, docs/DECISIONS.md, codex/STATUS.md e docs/phases/PHASE_05.md. Consulte docs/DATABASE.md, docs/BUSINESS_RULES.md, docs/INTEGRATIONS.md, docs/ARCHITECTURE.md, docs/SECURITY.md e o checklist docs/phases/PHASE_05_ACCEPTANCE.md. A auditoria G.1 prevalece sobre decisões históricas.

Implemente somente este escopo: Charges, entrada/parcelas, alocações, PaymentPricingEngine, Decimal, Mercado Pago, InfinitePay e dinheiro autorizado. Criar reconciliação e base de refunds/adjustments. Testar fake primeiro e adapters reais no ambiente disponível; não habilitar Marketplace.

Dependência: PHASE_04 concluída. Verifique as evidências existentes; não refaça trabalho já aceito nem avance sobre segurança quebrada.
