# Prompt de implementação — PHASE_09

Você está implementando a PHASE_09: Operação da viagem e embarque, no SaaS multiagência de excursões/viagens.

Leia AGENTS.md, README.md, docs/SPEC.md, docs/AUDIT_G1.md, docs/DECISIONS.md, codex/STATUS.md e docs/phases/PHASE_09.md. Consulte docs/SCREENS.md, docs/BUSINESS_RULES.md, docs/DATABASE.md, docs/PERMISSIONS.md e o checklist docs/phases/PHASE_09_ACCEPTANCE.md. A auditoria G.1 prevalece sobre decisões históricas.

Implemente somente este escopo: Sessão operacional, equipe, pontos de embarque, check-in por passageiro, mudanças autorizadas, checklists, ocorrências e encerramento online mobile.

Dependência: PHASE_08 concluída. Verifique as evidências existentes; não refaça trabalho já aceito nem avance sobre segurança quebrada.
