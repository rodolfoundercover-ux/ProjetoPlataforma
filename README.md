...
**PHASE_00 iniciada: código da fundação criado, ainda sem instalação ou homologação completas.**

Para abrir no VS Code e executar localmente, siga [Desenvolvimento local](docs/LOCAL_DEVELOPMENT.md). Veja [STATUS.md](codex/STATUS.md) para testes realizados e bloqueios. Não há aplicação comercial pronta nem avanço para PHASE_01.
